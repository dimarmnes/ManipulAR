...
#define OUTPUT_TONE_PITCH NOTE_DS5
#define SIDE_TONE_PITCH NOTE_DS5
...
class MorseSpeaker
{
  public:
    ...
    void setOutputTonePitch(unsigned int pitch);
    void setSideTonePitch(unsigned int pitch);
    boolean outputToneOn;
    boolean sideToneOn;
  private:
    boolean keyDown;
    unsigned int outputTonePitch;
    unsigned int sideTonePitch;
  protected:
    int spkrOut;
};
